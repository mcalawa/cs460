...
namespace Calculator
{
    interface IStackADT
    {
	     ...
	     * item removed.
	     * @return A reference that was popped (and removed) from the stack or null if the stack is empty*/
        object Pop();
	     ...
	     * @return A reference to the item currently on the top of the stack or null if the stack is empty*/
        object Peek();
